(function(){
    ...
    window.smartInitHook=function(config){
        ...
        config.plugins.simpleMobile=[
            {js:rootPath+"/common/sdk/sdk.js",css:rootPath+"/modules/simple/mobile.main.css"},
            {css:rootPath+"/modules/simple/mobile.common.css"},
            {css:rootPath+"/common/font-awesome-4.7.0/css/font-awesome.min.css"}
        ];
        config.plugins.simplePc=[
            {js:rootPath+"/common/sdk/sdk.js",css:rootPath+"/modules/simple/pc.main.css"},
            {css:rootPath+"/modules/simple/pc.common.css"},
            {css:rootPath+"/common/font-awesome-4.7.0/css/font-awesome.min.css"}
        ];
