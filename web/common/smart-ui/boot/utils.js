(function(){
    ...
    * */
    ...
    window.initVersion=function(vc){
        ...
        /*页面小图标,书签小图标*/
        document.write('<link id="web_shortcut" href="' + config.logo+'?jsv='+version+'" rel="shortcut icon" />');
        document.write('<link id="web_bookmark" href="' + config.logo+'?jsv='+version+'" rel="bookmark" />');
        /*禁用缓存*/
